...
function(get_all_src_file src_dir src_list)
    file(GLOB_RECURSE H_SRCS ${src_dir}/*.h)
    file(GLOB_RECURSE C_SRCS ${src_dir}*.c)
    file(GLOB_RECURSE HPP_SRCS ${src_dir}*.hpp)
    file(GLOB_RECURSE CPP_SRCS ${src_dir}*.cpp)
    set(${src_list} ${H_SRCS} ${C_SRCS} ${HPP_SRCS} ${CPP_SRCS})
endfunction(get_all_src_file src_dir)
